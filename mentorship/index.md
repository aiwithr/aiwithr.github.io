...
## ৯৫ জনের অন-লাইন মেন্টরশীপ, গুগল মিট + স্ল্যাক অ্যাপ

<div class="badges">
	<span class="badge info">১ম ব্যাচ: ২২ ফেব্রুয়ারি, ২০২২ - ২০ এপ্রিল, ২০২২</span>	
</div>

এখানে "নন-প্রোগ্রামারদের জন্য" অর্থ হচ্ছে সবাই (সিএসই/নন-সিএসই) আবেদন করতে পারবেন।

আমার অভিজ্ঞতা বলে ডেটা থেকে প্যাটার্ন অ্যানালাইসিসে ছাত্রীরা কিছুটা এগিয়ে আছেন। আমার হাতের ডেটা বলছে - মেয়েরা ডেটা অ্যানালিস্ট হিসেবে ভালো করছেন বিশ্বব্যাপী। আমার স্ত্রী ব্যাংকিং সেক্টরে আছেন ২০ বছর ধরে। মহিলারা বোঝেন ভালো ডাটার ভেতরের গল্প। 
...
গত ২ বছর ধরে কোর্সগুলোকে ফুল স্কেলে অডিটিং করে যা বোঝা গেল, বিশাল ইনভেস্টমেন্ট করেছে গুগল এবং আইবিএম এর মতো কোম্পানিগুলো - এই গ্যাপ পূরণে। আমি তাদের কোর্সওয়ার্ক ম্যাটেরিয়াল দেখে সত্যিকারভাবে অভিভূত। এই কোর্সগুলো করতে বিশেষ কোন প্রাতিষ্ঠানিক পড়াশোনার প্রয়োজন নেই।
{: .notice}

এর পাশাপাশি, ওই কোর্সওয়ার্কগুলো এবং আমার অভিজ্ঞতা মিলিয়ে নন-প্রোগ্রামারদের জন্য বাংলায় আমার ডেটা অ্যানালিস্ট মেন্টরশীপ প্রোগ্রাম তৈরি করেছি [গুগল ডাটা অ্যানালিটিক্স সার্টিফিকেশন](https://www.coursera.org/professional-certificates/google-data-analytics)কে ঘিরে। একটা সত্যিকারের ডেটা-অ্যানালাইটিক্স কোর্স চালাতে সময় লাগবে ৬-৮ মাস, প্রতি সপ্তাহে ১৫-২০ ঘন্টা সময় দিলে। আমার অভিজ্ঞতা অন্ততঃ তাই বলে। নন-প্রোগ্রামারদের কথা ভেবে। তবে সেটাকে কমিয়ে আনা যায় ৩ মাসে। মনে রাখবেন, গুগল ডাটা অ্যানালিটিক্স সার্টিফিকেশন করা যায় একদম নিজে থেকে, আমার মেন্টরশীপ আপনাকে সাহায্য করবে গ্লোবাল পার্সপেক্টিভ (আরও হাজারো কোর্স) এবং এই লাইনে আমার হাত ধরে (হ্যান্ডহোল্ডিং) ঢুকতে। 
...
৫টা ডাটা সাইন্সের বই লিখতে লিখতে মনে হলো নন-প্রোগ্রামারদের ডাটা বোঝার সহজ উপায় কী? সেই হিসেবে ডাটা অ্যানালাইটিক্সের জন্য একটা এক্সক্লুসিভ বই, এর পাশাপাশি প্রায় একশ ভিডিও তৈরি করছিলাম ব্যাপারটিকে সহজ করে আনার জন্য। এই উন্মুক্ত অর্থাৎ ফ্রী জিনিসগুলো নিয়ে কাজ করতে গিয়ে মনে হয়েছে, বিশেষায়িত জিনিসপত্রের আবেদন হারায় যখন এটাকে ফ্রীমিয়াম মডেলে চালানো হয়। তখন থেকেই আমি অন্য চিন্তাভাবনা শুরু করি। 
...
আমার রিসার্চ বলে গুগল ডাটা অ্যানালিটিক্স সার্টিফিকেশন সাধারণত: ১৭৪ ঘন্টা সময় নেয় কমপ্লিট করতে। ছবি দুটো দেখুন। এটা কমিয়ে আনা সম্ভব, তবে 'এইড এপ্লিকেশন' প্রসেস শুরু থেকে শেষ পর্যন্ত বাড়তি সময়ের কারণে ৩ মাসের নিচে আনা কষ্টকর।
...
এই ৩২ ঘন্টার জন্য (শুরুর ব্যাচ ৯৫ জন - যাতে ৫০টা সার্টিফিকেশন আনা যায় ৪ মাসে) কিছুটা *প্রিমিয়াম* প্রাইসিং বলেছি নিচে। কোন প্রি-রিকুইজিট নেই। আমি সিরিয়াস লার্নার এবং কমিটমেন্ট চাই। 
...
আমার দুটো সন্তানকে (৯ম এবং কলেজে পড়ছিলো) দেখিয়েছিলাম কিভাবে গুগল ডাটা অ্যানালাইটিক্স সার্টিফিকেশন শুরু করতে হয়। ফিনান্সিয়াল অ্যাসিস্ট্যান্স থেকে শুরু  তাদের জার্নিটা আমি দেখেছি - অসাধারণ কনসেপ্ট - গুগল এবং কোর্সেরা মিলে অসাধারণ কোর্স কনটেন্ট নিয়ে এসেছে, তবে আমাদের এডুকেশন সিস্টেমের সাথে একটা গ্যাপ থাকাতে শুরুতে এই জিনিসটা বুঝতে হয়তোবা অনেককে কিছু কাঠ খড় পোড়াতে হবে।
{: .notice-info}

আবারো বলছি, সমস্যা হচ্ছে এটা মোট ৮টা কোর্সের বিশাল আলাপ। ডাটা কে কিভাবে একদম শুরু থেকে বুঝতে হয়, হ্যান্ডেল করতে হয় এবং ডাটা থেকে লব্ধ জ্ঞান নিয়ে সেটা কিভাবে ব্যবসায় ব্যবহার করা যায়, সেটা না দেখলে বোঝার উপায় নেই। গুগল এবং কোর্সেরা তাদের এতদিনের জ্ঞান দিয়ে তৈরি করেছে এই চমৎকার সার্টিফিকেশন।

#### আমি কি করতে চাই না 

১. আপনাদের পরীক্ষাতে (প্র্যাকটিস এবং গ্রেডেড ক্যুইজ) সরাসরি সাহায্য করবো না - তবে ক্লাসগুলোর ম্যাটেরিয়াল বিশদভাবে পড়িয়ে পরীক্ষার জন্য তৈরি করে দেবো যাতে ভবিষ্যৎ ডাটা অ্যানালিস্ট ইন্টারভিউ ক্র্যাক করা যায় - ৩৬০ ডিগ্রী ভিউ।  
...
২. আপনার কাছ থেকে লিখিত কমিটমেন্ট লেটার নেব যাতে আপনি আমার সাথে ৩২ ঘন্টা লেগে থাকেন। আমি চাইবো না আপনি এই সার্টিফিকেশন মিস করেন। ৯৫টি সিটের মধ্যে ৫০টি গুগল ডাটা অ্যানালাইটিক্স সার্টিফিকেশন আনতে পারলে একটা চমৎকার ব্যাপার হবে। 
...
৫. 'গুগল ডাটা অ্যানালিটিক্স সার্টিফিকেশন' হয়ে গেলে আপনাদেরকে দেখিয়ে দেবো ডাটা সায়েন্টিস্ট হবার ক্রসরোড। এটাই ফাইনাল ডেস্টিনেশন!

ডাটা এনালাইসিস এর পাশাপাশি প্রচুর 'সফট স্কিল' নিয়ে আলাপ হবে এই জার্নিতে। আমরা তৈরি করবো বিশাল ডাটা কম্যুনিটি।
...
## ৩ মাসের মেন্টরশীপের কোর্স আউটলাইন/টাইমলাইন

কারিকুলাম এবং রিসোর্সের জন্য চোখ রাখুন [এখানে] এবং [এখানে](https://www.coursera.org/professional-certificates/google-data-analytics)। ১০টা *মাস্ট* ক্লাস হবে শুক্রবার সকাল ১০-১২টা। ১০ x ২ ঘন্টা = ২০ ঘন্টা। প্রতি সপ্তাহের শনিবারে রাত ৯টা থেকে ১০টা =১ ঘন্টা x ৪ সপ্তাহ x ৩ মাস = ১২ ঘন্টা। মোট ৩২ ঘন্টা।
{: .notice-info}
...
##  কিছু ফ্রি ট্রেনিংয়ের কোর্স আউটলাইন

ফ্রি হিসেবে কিছু ক্লাস তৈরি করে রেখেছি ইউটিউব প্লেলিস্টে। দেখুন এখানে, [প্লে-লিস্ট:](https://youtube.com/playlist?list=PL5NPSn95n_L4Z5bpCOqHW_QU8nxgywGM2) হিসেবে।
...
## প্রাইসিং: ১২০০০ টাকা, ৫০% ডিসকাউন্ট = ৬০০০ (১ম ব্যাচ)

এই প্রাইসিং নিয়ে দুই সপ্তাহ যুদ্ধ করেছি নিজের সাথে। ইন্ডাস্ট্রির বড় বড় এক্সপার্টদের সাথে যখন আমি নিজে যুদ্ধ করেছি প্রিমিয়াম কনটেন্ট ফ্রী হিসেবে দেওয়ার জন্য, তখন যেই উপলব্ধি হয়েছে, মানুষ ফ্রি কনটেন্ট পছন্দ করেন না। তার পেছনে সব চেয়ে বড় কারন হচ্ছে, সেটার কোনো কন্সিস্টেনসি নেই (কনটেন্ট তৈরিকারক নিজের সময় মাফিক করেন)। ফলে, সেই কনটেন্টের উপর কোনো জবাবদিহিতা থাকে না। 

এই কোর্সের প্রাইসিং কত হতে পারে সেটার ব্যাপারে সবার কাছে মতামত চেয়েছিলাম। এর পাশাপাশি আমার নিজের তিন মাসের ক্যালেন্ডার লক করার জন্য যুদ্ধ করতে হয়েছে। কারণ আমি যখন টাকা নেব, তখন আমাকে অবশ্যই ডেলিভার করতে হবে "রেইন সাইন"। বিশাল একটা স্ট্র্যাটেজি নিয়ে কাজ করতে হয়েছে যাতে ন্যূনতম ৫০টা সার্টিফিকেশন পাওয়া যায় এই তিন মাসে।

## আবেদনের নিয়ম

- [x] ১. "আপনি কেন এই ডেটা-অ্যানালাইটিক্স নিয়ে নন-প্রোগ্রামারদের জন্য 'এক্সক্লুসিভ' মেন্টরশীপ করতে চান?" প্রশ্নের উত্তর লিখে ফেলুন কয়েক লাইনে, নিচের ফর্মে।

- [x] ২. আপনার আবেদনের প্রেক্ষিতে, আমি আপনার সাথে কথা বলে নেব, বোঝার জন্য - যাতে আপনি এই তিন মাসের জার্নি সম্পর্কে অবগত থাকেন। আপনার এবং আমার এই কমিটমেন্ট কোন লেভেল পর্যন্ত যেতে পারে, সেটা মিলে গেলে আপনার কাছ থেকে টাকা নেবার প্রসেস শুরু করব। টাকা ফেরৎযোগ্য নয়।

- [x] ৩. আপনার সাথে প্রতিনিয়ত যোগাযোগ করার জন্য ব্যবহার করব 'স্ল্যাক' অ্যাপ্লিকেশন। সব ক্লাস হবে গুগল মিট এ। ক্লাস *অবশ্যই* অ্যাটেন্ড করতে হবে পিসিতে।
